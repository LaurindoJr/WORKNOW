...
STATUS_SK_VALUE  = os.getenv("STATUS_SK_VALUE")

AUDIT_PK_NAME    = os.getenv("AUDIT_PK_NAME", "id")
AUDIT_SK_NAME    = os.getenv("AUDIT_SK_NAME")
AUDIT_PK_PREFIX  = os.getenv("AUDIT_PK_PREFIX", "")
AUDIT_SK_VALUE   = os.getenv("AUDIT_SK_VALUE")
